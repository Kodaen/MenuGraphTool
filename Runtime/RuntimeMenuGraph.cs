...
namespace MenuGraphTool
{
    ...
    public class RuntimeMenuNode
    {
        ...
        // ExecutionFlow to NodeId mapping
        public SerializableDictionary<string, string> NextNodeDict = new();

        // maps every input port of the Node to the output ports of the other nodes, to fetch the data when the menu opens
    ...
    public class SerializableDictionary<TKey, TValue> : IEnumerable
    {
        ...
        public SerializableDictionary(params (TKey, TValue)[] Inputs)
        {
